# File generated by RizomUV 2022.1.58.g2aeb815ac
...
class CRizomUVLinkBase:
	def __init__(self):
		...
		self.description = "An open source Python module to control a RizomUV Standalone instance from a DCC application."
		self.website = "https://rizom-lab.com"

	def Execute(self, commandName, parameters):
		return self.rizomuv.Execute(commandName, parameters)
	...
	def RizomUVVersion(self):
		return self.rizomuv.Execute("Get", "Vars.Infos.Version.Full")
        
	def LibTaskUpdate(self, dic):
		"""
		Intended for internal use only
		"""
		return self.rizomuv.Execute('LibTaskUpdate', dic)

	def PsExport(self, dic):
		"""
		Export UV layout in a postscript file.
		"""
		return self.rizomuv.Execute('PsExport', dic)

	def LibTaskEnd(self, dic):
		"""
		Intended for internal use only
		"""
		return self.rizomuv.Execute('LibTaskEnd', dic)
	...
	def Load(self, dic):
		...
		"""
		return self.rizomuv.Execute('Load', dic)

	def InitLib(self, dic):
		"""
		Initialize the API
		...
		"""
		return self.rizomuv.Execute('InitLib', dic)

	def RasterExport(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('RasterExport', dic)
	...
	def Save(self, dic):
		...
		"""
		return self.rizomuv.Execute('Save', dic)

	def PaintMap(self, dic):
		"""
		Modify map values
		"""
		return self.rizomuv.Execute('PaintMap', dic)
	...
	def Hide(self, dic):
		...
		"""
		return self.rizomuv.Execute('Hide', dic)
	...
	def Cut(self, dic):
		...
		"""
		return self.rizomuv.Execute('Cut', dic)
	...
	def Weld(self, dic):
		...
		"""
		return self.rizomuv.Execute('Weld', dic)

	def ResetTo3d(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('ResetTo3d', dic)
	...
	def Unfold(self, dic):
		...
		"""
		return self.rizomuv.Execute('Unfold', dic)

	def SymmetrySet(self, dic):
		"""
		Set symmetry plane parameters
		"""
		return self.rizomuv.Execute('SymmetrySet', dic)

	def Constrain(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('Constrain', dic)

	def Undo(self, dic):
		"""
		Undo last command
		"""
		return self.rizomuv.Execute('Undo', dic)

	def Redo(self, dic):
		"""
		Redo undoed command
		"""
		return self.rizomuv.Execute('Redo', dic)

	def Optimize(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('Optimize', dic)
	...
	def Pack(self, dic):
		...
		"""
		return self.rizomuv.Execute('Pack', dic)
	...
	def Select(self, dic):
		...
		"""
		return self.rizomuv.Execute('Select', dic)
	...
	def Move(self, dic):
		...
		"""
		return self.rizomuv.Execute('Move', dic)
	...
	def Deform(self, dic):
		...
		"""
		return self.rizomuv.Execute('Deform', dic)

	def IslandProperties(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('IslandProperties', dic)

	def IslandGroups(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('IslandGroups', dic)

	def Set(self, dic):
		"""
		Set Application Variable Value
		"""
		return self.rizomuv.Execute('Set', dic)

	def GenerateScriptingHelp(self, dic):
		"""
		Generate Help String or File
		"""
		return self.rizomuv.Execute('GenerateScriptingHelp', dic)

	def Quit(self, dic):
		"""
		Quit this program with error code 0
		"""
		return self.rizomuv.Execute('Quit', dic)

	def Exit(self, dic):
		"""
		Exit the program with the given error code as argument
		"""
		return self.rizomuv.Execute('Exit', dic)

	def SavePreferences(self, dic):
		"""
		Save preferences and current settings
		"""
		return self.rizomuv.Execute('SavePreferences', dic)

	def GenerateCheckerboardTexture(self, dic):
		"""
		Generate the check board texture. Must be called if its resolution or repetition count changed.
		"""
		return self.rizomuv.Execute('GenerateCheckerboardTexture', dic)

	def LoadUserTexture(self, dic):
		"""
		Load a texture from an image file (used for the viewports in texture mode User)
		"""
		return self.rizomuv.Execute('LoadUserTexture', dic)

	def LoadGridTexture(self, dic):
		"""
		Load a texture from an image file (used for the viewports in texture mode Grid)
		"""
		return self.rizomuv.Execute('LoadGridTexture', dic)

	def Count(self, dic):
		"""
		Get table element count.
		"""
		return self.rizomuv.Execute('Count', dic)

	def ItemNames(self, dic):
		"""
		Get a list of the names of the items contained in the table.
		"""
		return self.rizomuv.Execute('ItemNames', dic)

	def Eval(self, dic):
		"""
		Evaluate function.
		"""
		return self.rizomuv.Execute('Eval', dic)

	def Get(self, dic):
		"""
		Get some application data.
		"""
		return self.rizomuv.Execute('Get', dic)

	def GetAsString(self, dic):
		"""
		Get some application data and transform them into a string.
		"""
		return self.rizomuv.Execute('GetAsString', dic)

	def Test(self, dic):
		"""
		Test internal code of RizomUV
		"""
		return self.rizomuv.Execute('Test', dic)

	def LoadPrefs(self, dic):
		"""
		Load preferences and set UI widgets according to the loaded values
		"""
		return self.rizomuv.Execute('LoadPrefs', dic)

	def IslandCopy(self, dic):
		"""
		...
		"""
		return self.rizomuv.Execute('IslandCopy', dic)
	...
	def Uvset(self, dic):
		...
		"""
		return self.rizomuv.Execute('Uvset', dic)
